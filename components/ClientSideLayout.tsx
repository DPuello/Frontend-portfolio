...
const ClientSideLayout: React.FC<ClientSideLayoutProps> = ({
  ...
  useEffect(() => {
    ...
    if (
      ...
      webGLSupported === true &&
      retry3DCount < PERFORMANCE_CONFIG.MAX_DOWNGRADE_ATTEMPTS
    ) {
  ...
  const gradientOpacity =
    performance === "gradient" || webGLSupported === false ? 1 : 0.2;
  ...
  return (
    <>
      ...
      {!(
        ...
        !isMobile && (
          <GradientBackground
            ...
            showDots={
              performance === "gradient" || webGLSupported === false || true
            }
            theme={theme}
      ...
      {isClient &&
        ...
        !isMobile &&
        performance !== "low" && (
          <Background3D setBg3dVisible={setBg3dVisible} />
        )}
