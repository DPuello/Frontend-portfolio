...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-default-50 dark:bg-dark-primary-900/50 backdrop-blur-sm py-12 mt-12">
      <div className="container mx-auto max-w-7xl px-6">
        ...
        {/* Divider */}
        <div className="border-t border-default-200 dark:border-default-700 my-8" />
